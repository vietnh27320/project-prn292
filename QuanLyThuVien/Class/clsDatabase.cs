...
namespace QuanLyThuVien.Class
{
    class clsDatabase
    {
        ...
        string strConnect = @"server=LAPTOP-3HNJNCEK\SQLEXPRESS; database=Library; user=sa; password=12345678";
        ...
        public void LoadDataToCombobox(ComboBox cb, string strSelect)
        {
            //Kết nối
            cb.Items.Clear();
            KetNoi();
