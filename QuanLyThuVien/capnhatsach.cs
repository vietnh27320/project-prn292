...
namespace QuanLyThuVien
{
    public partial class capnhatsach : Form
    {
        ...
        private void capnhatsach_Load(object sender, EventArgs e)
        {
            ...
            cls.LoadDataToCombobox(cboMATG, "select MATG from tblTacGia");
            cls.LoadDataToCombobox(cboMANXB, "select MANXB from tblNXB");
            cls.LoadDataToCombobox(cboMALv, "select MaLv from tblLinhVuc");
            cls.LoadDataToCombobox(cbotenLV, "select TenLv from tblLinhVuc");
            cls.LoadDataToCombobox(cbotenTG,"Select TENTG from tblTacGia");
            cls.LoadDataToCombobox(cbotenNXB,"Select TENNXB from tblNXB");
        }
